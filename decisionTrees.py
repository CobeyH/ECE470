...
decisionTreeRegressor = DecisionTreeRegressor(criterion="mse", random_state=0, max_depth=10)
...
for i in range(1,16):
	...
	decisionTreeRegressor = DecisionTreeRegressor(criterion="mse", random_state=0, max_depth=i)
...
RandomForestRegressor = RandomForestRegressor(n_estimators=500, max_depth=15)
